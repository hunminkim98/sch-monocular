...
class AmassDataset(BaseDataset):
    ...
    def _get_idx2meta(self):
        ...
        # perc_to_use = 0.75  # only use that much percent of the sequences
        # use_every_nth = int(1 / perc_to_use)
        # self.idx2meta = self.idx2meta[::use_every_nth]
        Log.info(f"[{self.dataset_name}] has {hours:.1f} hours motion -> Resampled to {len(self.idx2meta)} train samples.")
